			...
			<div className="mt-10 grid grid-cols-1 items-center justify-center gap-x-10 gap-y-[50px] sm:grid-cols-2 sm:space-y-0 md:mt-20 xl:flex xl:space-x-5">
				{content.map((item) => (
					<div
						...
						className="max-h-[300px] w-full max-w-[300px] justify-self-center rounded-3xl px-10 py-6 shadow-lg transition-transform duration-[0.7s] lg:shadow-md lg:hover:scale-110 lg:hover:shadow-lg"
					>
